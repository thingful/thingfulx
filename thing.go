...
type Thing struct {
	// Title is a short descriptive lable for the thing. This data is indexed by
	// Thingful.
	Title string

	// Description is a long form description about the thing. This data is
	// indexed by Thingful.
	Description string

	// Metadata is a slice of Tag objects encoding metadata about the Thing that
	// relates to the whole Thing not just an individual channel. This data is
	// indexed by Thingful.
	Metadata []Tag
